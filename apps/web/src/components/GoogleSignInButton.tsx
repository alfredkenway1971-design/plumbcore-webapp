  ...
  return (
    <div>
      <button
        ...
        className="w-full h-11 rounded-full ring-1 ring-border text-muted-foreground text-sm font-medium hover:bg-muted transition-all active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2.5"
      >
