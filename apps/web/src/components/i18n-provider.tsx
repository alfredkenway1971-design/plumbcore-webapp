...
const defaultTranslations: Translations = {
  ...
  home: {
    ...
    pricingTitle: "One Flat Price. Pre-Paid Leads Included.",
    pricingSubtitle: "Every plan includes customer deposits ($49–$199) credited to your invoice. Higher tiers get faster lead access and more AI receptionist hours.",
    ...
    depositTiersTitle: "Customer Deposit Tiers",
    depositTiersSub: "The deposit is credited to your invoice (deducted from the final bill).",
    depositColJobValue: "Estimated Job Value",
    ...
    priorityTitle: "How Lead Priority Works",
    prioritySub: "Higher-value jobs go to higher-tier subscribers first.",
    priorityColJobValue: "Job Value",
    priorityColWhoGets: "Who Gets Notified First",
    ...
    priority2000plusDesc: "Business first (10 min), Pro (10 min), Solo (20 min)",    planSolo: "Solo",
    planPro: "Pro",
    planBusiness: "Business",
    planEnterprise: "Enterprise",
    planSoloTechs: "1 tech",
    planProTechs: "2–5 techs",
    planBusinessTechs: "6–12 techs",
    planEnterpriseTechs: "25+ techs",
    planSoloLeads: "Up to 10",
    planProLeads: "Up to 25",
    planBusinessLeads: "Unlimited",
    planEnterpriseLeads: "Unlimited + territory",
    planSoloAI: "15 hrs",
    planProAI: "60 hrs",
    planBusinessAI: "150 hrs",
    planEnterpriseAI: "Unlimited",
    planSoloFeature1: "AI photo estimates",
    planSoloFeature2: "Scheduling & invoicing",
    planSoloFeature3: "Lead intake with deposits",
    planSoloFeature4: "Standard lead queue",
    ...
    planEnterpriseFeature5: "Exclusive zone rights",
    contactUs: "Contact Us",
    startFreeTrialArrow: "Start Free Trial →",
    startFreeTrialNoCard: "Start Free Trial — No Card Needed",
    redirecting: "Redirecting...",
    depositNote: "Deposit ($49–$199) credited to your final invoice.",
