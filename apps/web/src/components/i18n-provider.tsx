...
const defaultTranslations: Translations = {
  ...
  home: {
    ...
    heroLine2: "Leads.",
    heroSub: "Every lead is pre-qualified with a refundable deposit — homeowners prove they're serious before you ever roll a truck. No more no-shows. No more tire-kickers.",
    ...
    step2Desc: "Customer pays a refundable deposit to PlumbCore — it qualifies the lead before you dispatch anyone.",
    ...
    depositTitle: "Deposit Pre-Qualifies Every Lead",
    depositSub: "The deposit is collected and retained by PlumbCore as a lead qualification fee. Homeowners prove they're serious — you get real, ready-to-buy leads with zero wasted trips.",
