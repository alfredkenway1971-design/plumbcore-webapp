    ...
    <main className="min-h-screen bg-muted">
      <div className="max-w-lg mx-auto px-4 py-20">
        <div className="text-center mb-10">
          ...
          <p className="text-muted-foreground mt-2">Manage your plan, payment methods, and invoices</p>
        </div>

        <div className="bg-white rounded-2xl border border-border/50 p-6 shadow-sm mb-6">
          <h2 className="text-lg font-bold text-foreground mb-4">What you can do here</h2>
        ...
        <div className="bg-white rounded-2xl border border-border/50 p-6 shadow-sm">
          ...
          <input
            ...
            className="w-full h-11 px-4 rounded-xl border border-border text-sm focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent mb-3"
          />
          {error && (
            <div className="text-sm text-red-500 mb-3">
              ...
              <a
                href="/#pricing"
                className="inline-flex items-center gap-1.5 mt-2 px-4 py-2 rounded-lg bg-primary text-white text-xs font-semibold hover:bg-primary/90 transition-colors"
              >
        ...
        <div className="text-center mt-8">
          <p className="text-xs text-muted-foreground/80 mb-2">Don't have a subscription yet?</p>
          <a
            href="/#pricing"
            className="inline-flex items-center gap-1.5 text-sm text-primary font-semibold hover:text-primary/80"
          >
