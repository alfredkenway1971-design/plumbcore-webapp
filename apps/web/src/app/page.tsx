      ...
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-0">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-x-6 gap-y-2 mt-2">
...
export default function LandingPage() {
  ...
  return (
    <main className={`min-h-screen bg-white ${menuOpen ? 'overflow-hidden' : ''} pb-16 md:pb-0 [--font-display:var(--font-outfit)]`}>
