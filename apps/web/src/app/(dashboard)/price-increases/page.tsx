...
function SkeletonRow() {
  return (
    <div className="flex items-center gap-4 px-4 py-3 animate-pulse">
      <div className="h-4 w-40 rounded bg-gray-50" />
  ...
  if (initialLoading) {
    return (
      <div className="p-4 sm:p-6 space-y-5">
        <div className="h-8 w-56 rounded bg-gray-50 animate-pulse" />
        <div className="h-5 w-72 rounded bg-gray-50 animate-pulse" />
        <div className="h-10 w-40 rounded bg-gray-50 animate-pulse" />
  ...
  return (
    <div className="p-4 sm:p-6 space-y-5">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Price Increase Detection</h1>
      ...
      {hasRun && changes.length > 0 && (
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          <Card variant="bordered" padding="md">
            <p className="text-xs font-medium text-gray-500 uppercase tracking-wider">Items Analyzed</p>
            <p className="text-2xl font-bold text-gray-900 mt-1">{stats.total}</p>
          </Card>
          <Card variant="bordered" padding="md">
            <p className="text-xs font-medium text-gray-500 uppercase tracking-wider">Flagged (&gt;5%)</p>
            <p className="text-2xl font-bold text-red-600 mt-1">{stats.flagged}</p>
          </Card>
          <Card variant="bordered" padding="md">
            <p className="text-xs font-medium text-gray-500 uppercase tracking-wider">Total Increase</p>
            <p className="text-2xl font-bold text-amber-600 mt-1">{formatCurrency(stats.totalIncrease)}</p>
          </Card>
          <Card variant="bordered" padding="md">
            <p className="text-xs font-medium text-gray-500 uppercase tracking-wider">Approved / Rejected</p>
          ...
          <table className="w-full min-w-[900px]">
            <thead>
              <tr className="border-b border-gray-200">
                ...
                <th className="px-4 py-3 text-right text-xs font-semibold uppercase tracking-wider text-gray-500">Old Price</th>
                <th className="px-4 py-3 text-right text-xs font-semibold uppercase tracking-wider text-gray-500">New Price</th>
                <th className="px-4 py-3 text-center text-xs font-semibold uppercase tracking-wider text-gray-500">Change %</th>
                <th className="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wider text-gray-500">Recommendation</th>
