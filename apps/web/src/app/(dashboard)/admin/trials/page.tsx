...
const riskStyles: Record<string, { bg: string; text: string; dot: string; label: string }> = {
  ...
  medium: { bg: 'bg-amber-50', text: 'text-amber-600', dot: 'bg-amber-500', label: 'Medium Risk' },
