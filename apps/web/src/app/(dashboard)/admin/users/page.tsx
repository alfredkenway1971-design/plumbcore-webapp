  ...
  return (
    <div className="p-4 sm:p-6 space-y-5">
      <div className="flex items-center justify-between">
        <div><h1 className="text-xl sm:text-2xl font-bold text-foreground">Admin Users</h1><p className="text-sm text-muted-foreground mt-0.5">Manage admin accounts and permissions</p></div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full min-w-[500px] text-sm">
              <thead><tr className="bg-muted border-b border-border">
                ...
                <th className="text-left px-4 py-3 font-semibold text-foreground">Last Login</th>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="bg-white rounded-2xl shadow-xl max-w-lg w-full mx-4 max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between p-5 border-b border-border/50">
              <h2 className="text-lg font-semibold text-foreground">Add Admin User</h2>
            ...
            <div className="space-y-4 p-5">
              ...
              <div><label className="text-xs font-medium text-muted-foreground/80 uppercase tracking-wider">Permissions</label>
                <div className="grid grid-cols-2 gap-1.5 mt-1">
                  {allPermissions.map(p => (
                    <label key={p} className="flex items-center gap-2 text-xs text-foreground cursor-pointer">
