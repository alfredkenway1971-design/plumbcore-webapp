  ...
  return (
    <div className="max-w-[1440px] mx-auto">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div>
          <h1 className="text-2xl font-semibold tracking-tight text-foreground">AI Usage Stats</h1>
          <p className="text-sm text-muted-foreground mt-1">Monitor AI feature adoption and usage patterns</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl ring-1 ring-slate-200 shadow-sm ring-1 ring-black/5 p-16 text-center">
        ...
        <h3 className="text-xl font-semibold text-foreground mb-2">No AI usage data yet</h3>
