  ...
  return (
    <div className="max-w-[1440px] mx-auto p-6">
      <div className="bg-white rounded-2xl border border-red-100 shadow-sm p-8 text-center">
        ...
        <h3 className="text-base font-semibold text-slate-900 mb-1">Failed to load customers</h3>
...
function CustomersEmpty() {
  return (
    <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-8 text-center">
      ...
      <h3 className="text-base font-semibold text-slate-900 mb-1">No customers yet</h3>
          ...
          <div className="flex flex-col sm:flex-row gap-3 items-start sm:items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <select value={planFilter || ''} onChange={e => setPlanFilter(e.target.value || null)}
                className="h-9 px-3 rounded-xl border border-slate-200 text-xs font-medium text-slate-500 focus:outline-none">
              ...
              return (
                <div key={company.id} className="px-5 py-4 hover:bg-slate-50 transition-colors flex items-center gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      <span className="text-sm font-semibold text-slate-900 truncate">{company.name || 'Unnamed'}</span>
