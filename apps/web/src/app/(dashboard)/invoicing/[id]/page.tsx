  ...
  return (
    <div className="p-4 sm:p-6 space-y-6 max-w-4xl">
      ...
      <Card variant="default" padding="md">
        ...
        {invoice.status === 'overdue' && (
          <div className="mt-3 rounded-xl bg-red-50 border border-status-error/20 px-3 py-2">
        ...
        {invoice.paidAmount !== undefined && invoice.paidAmount !== null && invoice.paymentMethod && (
          <div className="mt-3 rounded-xl bg-green-50 border border-status-success/20 px-3 py-2">
