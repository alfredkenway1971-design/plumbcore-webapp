...
function SkeletonPage() {
  return (
    <div className="p-4 sm:p-6 space-y-5">
      <div className="h-8 w-32 rounded bg-gray-50 animate-pulse" />
      <div className="h-5 w-56 rounded bg-gray-50 animate-pulse" />
      <div className="flex gap-4 h-[calc(100vh-220px)]">
        ...
        <div className="w-1/2 rounded-xl bg-gray-50 animate-pulse" />
      </div>
    </div>
  );
}
  ...
  return (
    <div className="p-4 sm:p-6 h-[calc(100vh-64px)] flex flex-col">
      ...
      <div className="flex items-center justify-between mb-4 shrink-0">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-gray-900">SMS Messaging</h1>
          <p className="text-sm text-gray-500 mt-0.5">Send and receive SMS messages</p>
        </div>
      ...
      <div className="flex-1 flex flex-col lg:flex-row gap-4 min-h-0">
        ...
        <div className="w-full lg:w-1/2 flex flex-col rounded-xl border border-gray-200 bg-white overflow-hidden">
          {/* Search */}
                ...
                >
                  <div className="flex items-start justify-between">
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-xs text-gray-500 mt-0.5 truncate">{conv.phoneNumber}</p>
                      <p className="text-xs text-gray-400 mt-1 truncate">{conv.lastMessage}</p>
                    </div>
                    <div className="flex flex-col items-end gap-1 shrink-0 ml-2">
                      <span className="text-[10px] text-gray-400 whitespace-nowrap">{conv.lastTime}</span>
                      {conv.unread > 0 && (
                ...
                {selectedConversation.messages.length === 0 ? (
                  ...
                  selectedConversation.messages.map((msg) => (
                    ...
                    >
                      ...
                      >
                        <p>{msg.content}</p>
                        <p className={`text-[10px] mt-1 ${msg.sent ? 'text-blue-200' : 'text-gray-400'}`}>
                          {msg.timestamp}
                        </p>
                      </div>
                    </div>
              ...
              <div className="shrink-0 border-t border-gray-200 p-3">
                <div className="flex items-end gap-2">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <button
                      className="flex h-9 w-9 items-center justify-center rounded-lg text-gray-400 hover:text-gray-600 hover:bg-gray-100 transition-colors"
        ...
        <div className="space-y-2">
          {smsTemplates.map((t, i) => (
            ...
            >
              ...
              <p className="text-xs text-gray-500 mt-0.5">{t.template}</p>
            </button>
          ))}
        </div>
      </Modal>
