...
const statusColor: Record<Job['status'], string> = {
  ...
  cancelled: 'bg-steel-dark/20 text-muted-foreground',
};
...
export default function ClientDetailPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <a
        href="/clients"
        className="inline-flex items-center gap-1.5 text-sm font-medium text-muted-foreground/80 hover:text-foreground transition-colors"
      >
      ...
      {!loading && client && (
        <Card variant="default" padding="md">
          ...
          {properties.length === 0 ? (
            <p className="text-sm text-muted-foreground">No properties saved for this client.</p>
          ) : (
            <div className="space-y-2">
              {properties.map((prop, i) => (
                ...
                >
                  <div className="flex items-center gap-2">
                    <svg className="h-4 w-4 text-muted-foreground/80" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
      ...
      {/* ── Job History Table ── */}
      <div>
        <h2 className="mb-3 text-sm font-semibold text-foreground">Job History</h2>
        {loading ? (
          <div className="space-y-2">
              ...
              <tbody>
                {clientJobs.map((job) => (
                  ...
                  >
                    ...
                    <td className="py-3 px-4 text-muted-foreground/80 whitespace-nowrap">
